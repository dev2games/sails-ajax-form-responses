 ...
 * @event update:cloudResponse       [.sync]
...
parasails.registerComponent('ajaxForm', {
  ...
  props: [
    ...
    'cloudResponse', // « 2-way bound (.sync)
    'action',
  ...
  methods: {
    ...
    submit: async function () {
      ...
      this.$emit('update:cloudResponse', '');
      ...
      if (!failedWithCloudExit) {
        //Updates the 'cloudResponse'
        this.$emit('update:cloudResponse', result);
        this.$emit('submitted', result);
      } else {
        //Updates the 'cloudResponse' with the response-info
        this.$emit('update:cloudResponse', rawErrorFromCloudSDK.responseInfo.body);
